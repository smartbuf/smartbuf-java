...
public abstract class Codec<T> {
     ...
     * @return 转换结果
     */
    public Boolean toBoolean(Type type, T t) {
     ...
     * @return 转换结果
     */
    public Float toFloat(Type type, T t) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 转换结果
     */
    public Double toDouble(Type type, T t) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 转换结果
     */
    public Long toVarint(Type type, T t) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 转换结果
     */
    public byte[] toBinary(Type type, T t) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 转换结果
     */
    public String toString(Type type, T t) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 转换结果
     */
    public Object toObject(Type type, T t) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 转换结果
     */
    public Collection toArray(Type type, T t) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 转换结果
     */
    public Map toMap(Type type, T t) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 编码结果
     */
    public Node toNode(Type type, T t) {
        throw new UnsupportedOperationException();
    }
