...
public class ThrowableCodecTest {
    ...
    public void testStackTraceElement() {
        ...
        assert element.getLineNumber() == newElement.getLineNumber();
        assert Objects.equals(element.getClassName(), newElement.getClassName());
        assert Objects.equals(element.getFileName(), newElement.getFileName());
        assert Objects.equals(element.getMethodName(), newElement.getMethodName());
