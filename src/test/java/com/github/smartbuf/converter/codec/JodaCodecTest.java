...
public class JodaCodecTest {
    ...
    public void testDateTime() {
        ...
        LocalTime localTime2 = codec.toLocalTime(codec.toLocalTime(localTime));
        assert localTime.toSecondOfDay() == localTime2.toSecondOfDay();
        ...
        LocalDateTime localDateTime2 = codec.toLocalDateTime(codec.toLocalDateTime(localDateTime));
        assert localDateTime.toEpochSecond(ZoneOffset.UTC) == localDateTime2.toEpochSecond(ZoneOffset.UTC);
    }
